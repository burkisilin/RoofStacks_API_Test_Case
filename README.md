...
| Get User - Invalid User ID                                        | User could not be found, proper error message should be shown                    | 404                  | Ok     |
| Get User - Invalid User ID 2                                      | User could not be found, proper error message should be shown                    | 404                  | Ok     |
| Get User - Empty User ID                                          | User could not be found, proper error message should be shown                    | 404                  | Failed |
|                                                                   |                                                                                  |                      |        |
| Remove User - Valid User ID                                       | The user should be removed successfully                                          | 204                  | Failed |
| Remove User - Invalid User ID                                     | Deletion should not be done, proper error message should be shown                | 404                  | Ok     |
| Remove User - Empty User ID                                       | Deletion should not be done, proper error message should be shown                | 404                  | Failed |
|                                                                   |                                                                                  |                      |        |
...
| Switch User Activity - Valid User ID - isActive: true (String)    | User Activity should not be set, proper error message should be shown            | 400                  | Failed |
| Switch User Activity - Valid User ID - isActive: false (String)   | User Activity should not be set, proper error message should be shown            | 400                  | Failed |
| Switch User Activity - Valid User ID - isActive: Empty            | User Activity should not be set, proper error message should be shown            | 400                  | Failed |
| Switch User Activity - Invalid User ID                            | User Activity should not be set, proper error message should be shown            | 400                  | Failed |
|                                                                   |                                                                                  |                      |        |
